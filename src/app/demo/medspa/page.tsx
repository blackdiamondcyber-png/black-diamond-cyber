...
export default function MedSpaDemoPage() {
  ...
  const sectionPad: CSSProperties = { padding: "96px 0" };
        ...
        >
          ...
          <div style={{ ...container, position: "relative", zIndex: 1, textAlign: "center" }}>
            <div style={{ maxWidth: "700px", margin: "0 auto" }}>
              ...
              <h1 style={{ ...heading, fontSize: "clamp(36px, 5.5vw, 60px)", color: "#fff", marginBottom: "20px", fontStyle: "italic" }}>
                Reveal Your Natural{" "}
      ...
      <style>{`
        * { box-sizing: border-box; margin: 0; }
        ...
        @media (max-width: 768px) {
          ...
          .spa-nav-links > a:not(:last-child) { display: none !important; }
